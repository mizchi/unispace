export function moveWindowToContainer(layout, fromWindowId, fromContainerId, toWindowId, toContainerId) {
...
export function selectWindowOnContainer(layout, windowId, containerId) {
    const newPanes = layout.panes.map(c => {
        if (containerId === c.id) {
